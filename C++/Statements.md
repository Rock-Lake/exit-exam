...
Also known as *loops*, these statements repeat a series of instruction a number of times, depending on the condition it was given. In C++ loops can be arranged in one of three ways:
- **for loop:** This is the simplest iterative statement that follows the general look:
		...
		*/
		...
		```
- **while loop:** this iterative staement